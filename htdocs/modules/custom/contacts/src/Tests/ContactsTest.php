...
class ContentEntityExampleTest extends ExamplesTestBase {
  ...
  public static $modules = array('contacts', 'block', 'field_ui');
  ...
  public function testContentEntityExample() {
    $web_user = $this->drupalCreateUser(array(
      ...
      'administer contact fields',
      'administer contact form display'));
    ...
    // Settings page.
    $this->drupalGet('admin/structure/contact_settings');
  ...
  protected function providerTestPaths($contact_id) {
    return array(
      ...
      array(
        200,
        'admin/structure/contact_settings',
        'administer contact entity',
      ),
      array(
        403,
